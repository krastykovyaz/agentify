...
def parse_args():
    p = argparse.ArgumentParser(description="Train Gemma LoRA for telegram_post")
    ...
    p.add_argument(
        "--default-system",
        default=(
            "Ты редактор Telegram-канала. Пиши пост на русском: цепкий заголовок, "
            "1-3 информативных абзаца, без выдумки новых фактов и без кликбейта."
        ),
    )
